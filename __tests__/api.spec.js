...
describe('api.basic test', () => {
  test('should throw when target is null/undefined', () => {
    expect(safeAssign(null, {})).toEqual({});
    expect(safeAssign(undefined, {})).toEqual({});
  });
  ...
  test('should work with multiple source', () => {
    expect(
      safeAssign({ foo: 1, bar: 2, baz: 3 }, { foo: 4 }, { bar: 5, baz: 6 }, { abc: { foo: 7 } })
